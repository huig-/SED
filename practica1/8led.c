...
int Symbol[] = { SEGMENT_A & SEGMENT_B & SEGMENT_C & SEGMENT_D & SEGMENT_E & SEGMENT_G, //0
	...
	SEGMENT_A & SEGMENT_G & SEGMENT_F & SEGMENT_B & SEGMENT_C, //9
	SEGMENT_A & SEGMENT_B & SEGMENT_C & SEGMENT_E & SEGMENT_F & SEGMENT_G, //A
	SEGMENT_G & SEGMENT_E & SEGMENT_F & SEGMENT_C & SEGMENT_D, //b
	SEGMENT_A & SEGMENT_G & SEGMENT_E & SEGMENT_D, //C
	SEGMENT_F & SEGMENT_E & SEGMENT_D & SEGMENT_C & SEGMENT_B, //d
	SEGMENT_A & SEGMENT_G & SEGMENT_F & SEGMENT_E & SEGMENT_D}; //E
